...
|---|---|---|
| **[LLM-Agent](https://github.com/VanKal2404/LLM-Agent)** | _(one-line summary — fill in)_ | Python, Groq/Gemini, function calling |
| **[llm-platform-lab](https://github.com/VanKal2404/llm-platform-lab)** | _(one-line summary — fill in)_ | _(fill in)_ |
| **[Local-RAG-Knowledge-Platform](https://github.com/VanKal2404/Local-RAG-Knowledge-Platform)** | Local-first RAG pipeline, fully private, free to run | FastAPI, Ollama, ChromaDB, sentence-transformers |
| **[AI-Codebase-Assistant](https://github.com/VanKal2404/AI-Codebase-Assistant)** | Repo analysis, Q&A, refactor suggestions, patch previews | FastAPI, Streamlit, FAISS, multi-provider LLM |
| **[predictive-maintenance-rul-platform](https://github.com/VanKal2404/predictive-maintenance-rul-platform)** | Probabilistic RUL prediction on NASA CMAPSS turbofan data | PyTorch, LSTM + uncertainty, Streamlit |
